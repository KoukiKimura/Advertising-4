...
import jp.PersonalDevelopment.Adbertising.Adbertising.NameKEY
import kotlinx.android.synthetic.main.activity_test.*
import java.io.ByteArrayOutputStream


class TestActivity : AppCompatActivity(), View.OnClickListener, DatabaseReference.CompletionListener {
    companion object {
...
//        mGenre = extras!!.getInt("genre")
        ...
        send_image_set.setOnClickListener(this)
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CHOOSER_REQUEST_CODE) {
            ...
            send_image_set.setImageBitmap(resizedImage)
    ...
    override fun onClick(v: View) {
        if (v === send_image_set) {
            ...
            // タイトルと本文を取得する
            val title = title_name_editText.text.toString()
            val desp = desp_editText.text.toString()
            ...
            // 添付画像を取得する
            val drawable = send_image_set.drawable as? BitmapDrawable
